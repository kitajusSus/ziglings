...
pub fn main() void {
    var n: u8 = 50; //change this line from const to var
    n = n + 5;

    const pi: u32 = 314159; //change this line from u8 to u32

    const negative_eleven: i8 = -11; //change this line from u8 to i8
